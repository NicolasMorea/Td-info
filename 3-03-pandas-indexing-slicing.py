...
# %%
print(type(df.loc[40]))
#c'est une ligne de la dataframe sous forme de série
df.loc[40,'Name']
#son nom est Jamila Nicola-Yarred
...
# %%
tail=df.loc[:,'Name'].tail(2)
print(tail.iloc[0])
#son nom est Erik Johansson

# %% [markdown]
# 4. localisez les 3 derniers éléments de la ligne d'index `40`

# %%
print(df.loc[40].iloc[-3:])
...
# %%
print(df.iloc[-10:].loc[:,['Name','Pclass','Survived']])
...
# %%
df[np.logical_and(np.logical_not(df.Pclass == 1),df.Age >= 70)]
